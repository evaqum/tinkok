...
abstract class $HomeScreenStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({HomeScreenTab currentTab});
}
...
class _$HomeScreenStateImpl implements _HomeScreenState {
  const _$HomeScreenStateImpl({required this.currentTab});
  ...
  @override
  String toString() {
    return 'HomeScreenState(currentTab: $currentTab)';
  }
...
abstract class _HomeScreenState implements HomeScreenState {
  const factory _HomeScreenState({required final HomeScreenTab currentTab}) =
